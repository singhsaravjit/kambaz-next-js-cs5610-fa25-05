/*export default function Lab1() {
    ...
    return (
        <div>
            <h1>Lab 1: Random Number Generator</h1>
...
export default function Lab1() {
  return (
    <div id="wd-lab1">
      <h1>Saravjit Singh ------ Section XX</h1>
      <h2>Lab 1</h2>
      <h3>HTML Examples</h3>
      <div id="wd-h-tag">
        <h4>Heading Tags</h4>
...
<ol id="wd-your-favorite-recipe">
  ...
  <li>Add pasta to the boiling water and cook until al dente.</li>
  <li>Drain the pasta and set it aside.</li>
  <li>Heat olive oil in a pan and sauté garlic.</li>
  <li>Add tomato sauce and season with salt, pepper, and herbs.</li>
  <li>Mix the cooked pasta into the sauce and stir well.</li>
...
Please
<a href="https://github.com/singhsaravjit/kambaz-next-js-cs5610-fa25-05" id="wd-github"> click here </a>
to my code repository on GitHub<br/>
